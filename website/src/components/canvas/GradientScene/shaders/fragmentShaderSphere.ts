export const fragmentShaderSphere = `
...
vec4 diffuseColor = vec4(mix(color1, color3, vNormal.x),1);
	// vec4 diffuseColor = vec4(mix(mix(color1, color3, smoothstep(-3.0, 3.0,vNormal.z)), color2, vNormal.z), 1);
